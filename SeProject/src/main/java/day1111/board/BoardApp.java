...
public class BoardApp extends JFrame{
	...
	public BoardApp() {
		...
		//생성
		p_north = new JPanel();
		bt_board = new JButton(ImageUtil.getIcon(this.getClass(), "res/boardPic.png", 100, 45));
		bt_regist = new JButton(ImageUtil.getIcon(this.getClass(), "res/registPic.png", 100, 45));
		bt_login = new JButton(ImageUtil.getIcon(this.getClass(), "res/loginPic.png", 100, 45));
		p_center = new JPanel();
