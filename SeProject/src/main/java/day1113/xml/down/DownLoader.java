...
public class DownLoader extends JFrame{
	...
	public void download(String path) {//매개변수로 가져올 자원을 지정한다!!
		...
		try {
			...
			fos = new FileOutputStream("C:/Users/tjdal/workspace/java_workspace/SeProject/res/download/"+filename);
			int data=-1;
			while(true) {
				data=is.read();
				readCount++;
